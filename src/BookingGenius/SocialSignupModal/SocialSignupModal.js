...
const SocialSignupModal = props => (
  ...
  >
    ...
    <Divider mt="25px" />
    <Button bg="#3b5998" block lg style={{ height: '60px' }}>
      <ButtonText>
        <Icon src={FacebookIcon} alt="facebook-icon" />Continue with Facebook
      </ButtonText>
    </Button>
    <Paragraph>or</Paragraph>
    <Button bg="#07730d" block lg style={{ height: '60px' }}>
      <ButtonText>
        <Icon src={MailIcon} alt="mail-icon" />Sign up with email
      </ButtonText>
    </Button>
    <Divider mt="22px" />
    <SecondaryHeader>

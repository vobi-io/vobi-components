...
const Icon = props => (
  <SliderIcon {...props}>
    {props.left &&
        (<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enableBackground="new 0 0 129 129" width="50px" height="50px">
          <g>
    ...
    render() {
        return (
          ...
          >
            ...
            <Player>
              {this.props.data.map((url,index) => index === this.state.currentIndex &&
              <iframe key={index} id="ytplayer" type="text/html" width="640" height="360"
                src={`https://www.youtube.com/embed/${youtube_parser(url)}?autoplay=1&modestbranding=1&rel=0&iv_load_policy=3`} frameBorder="0">
              </iframe>)}
